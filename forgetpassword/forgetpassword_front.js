...
function update () {
	var ifUpdate = 3;//ifUpdateFunc(user, newpassword.value.trim());
	...
	newpassword.style.borderColor = newpasswordColor;
	newpassword.addEventListener("focus", ()=>{newpassword.style.borderColor = "#ffb482";});
	newpassword.addEventListener("focusout", ()=>{newpassword.style.borderColor = pwordColor;});
	warning.innerHTML = warningText;
}